...
using RegistrationFormAPI.Controllers;
...
namespace RegistrationFormAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<DropDownRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "RegistrationFormAPI", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "RegistrationFormAPI v1"));
            }
